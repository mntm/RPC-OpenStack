...
1- Aller dans le répertoire ./TP1/partie_2/

2- Compiler avec la commande "ant"

3- Aller dans le répertoire ./TP1/partie_2/bin/

4- Entrer la commande "rmiregistry &"

5- Aller dans le répertoire ./TP1/partie_2/

6- Démarrer le serveur avec la commande "./server.sh" ou "bash ./server.sh"

7- Dans un autre terminal, aller dans le répertoire ./TP1/partie_2/
...
9- les utilisateurs inscris sont dans le fichier "legit_user" dans le répertoire ./TP1/partie_2/server/
